...
public class OpenWnnDictionaryImplJni {
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#APPROX_PATTERN_EN_TOUPPER
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
    public static final int APPROX_PATTERN_EN_TOUPPER               = WnnDictionary.APPROX_PATTERN_EN_TOUPPER;
    /**
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#APPROX_PATTERN_EN_TOLOWER
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR_UPPER
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#APPROX_PATTERN_JAJP_12KEY_NORMAL
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#SEARCH_EXACT
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
    public static final int SEARCH_EXACT                           = WnnDictionary.SEARCH_EXACT;
    /**
     * Constant about the search operation (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#SEARCH_PREFIX
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the search operation (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#SEARCH_LINK
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#ORDER_BY_FREQUENCY
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the sort order (for JNI native library)
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#ORDER_BY_KEY
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_V1
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    public static final int POS_TYPE_V1                             = WnnDictionary.POS_TYPE_V1;
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_V2
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_V3
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_BUNTOU
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_TANKANJI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_SUUJI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_MEISI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_JINMEI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_CHIMEI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see me.blog.hgl1002.openwnn.WnnDictionary#POS_TYPE_KIGOU
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#clearDictionary
     * @param work      The internal work area
     * @return          0 if processing is successful; <0 if an error occur
     */
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#setDictionary
     * @param work      The internal work area
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#searchWord
     * @param work          The internal work area
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#getNextWord
     * @param work      The internal work area
     ...
     *
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#getNextWord
     * @param work      The internal work area
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#clearApproxPattern
     * @param work      The internal work area.
     */
     ...
     *
     * @see me.blog.hgl1002.openwnn.WnnDictionary#setApproxPattern
     * @param work      The internal work area
     ...
     * @param type          The type of a part of speech
     * @return              0 if type is not found; <0 if an error occur; >0 The part of speech
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V1
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V2
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V3
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_BUNTOU
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_TANKANJI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_SUUJI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_MEISI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_JINMEI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_CHIMEI
     * @see me.blog.hgl1002.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_KIGOU
     */
