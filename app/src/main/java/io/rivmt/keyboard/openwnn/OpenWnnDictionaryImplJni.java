...
public class OpenWnnDictionaryImplJni {
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#APPROX_PATTERN_EN_TOUPPER
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
    public static final int APPROX_PATTERN_EN_TOUPPER               = WnnDictionary.APPROX_PATTERN_EN_TOUPPER;
    /**
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#APPROX_PATTERN_EN_TOLOWER
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR_UPPER
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#APPROX_PATTERN_JAJP_12KEY_NORMAL
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#SEARCH_EXACT
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
    public static final int SEARCH_EXACT                           = WnnDictionary.SEARCH_EXACT;
    /**
     * Constant about the search operation (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#SEARCH_PREFIX
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the search operation (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#SEARCH_LINK
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#ORDER_BY_FREQUENCY
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the sort order (for JNI native library)
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#ORDER_BY_KEY
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_V1
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    public static final int POS_TYPE_V1                             = WnnDictionary.POS_TYPE_V1;
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_V2
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_V3
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_BUNTOU
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_TANKANJI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_SUUJI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_MEISI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_JINMEI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_CHIMEI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#POS_TYPE_KIGOU
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#clearDictionary
     * @param work      The internal work area
     * @return          0 if processing is successful; <0 if an error occur
     */
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#setDictionary
     * @param work      The internal work area
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#searchWord
     * @param work          The internal work area
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#getNextWord
     * @param work      The internal work area
     ...
     *
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#getNextWord
     * @param work      The internal work area
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#clearApproxPattern
     * @param work      The internal work area.
     */
     ...
     *
     * @see io.rivmt.keyboard.openwnn.WnnDictionary#setApproxPattern
     * @param work      The internal work area
     ...
     * @param type          The type of a part of speech
     * @return              0 if type is not found; <0 if an error occur; >0 The part of speech
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V1
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V2
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V3
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_BUNTOU
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_TANKANJI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_SUUJI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_MEISI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_JINMEI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_CHIMEI
     * @see io.rivmt.keyboard.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_KIGOU
     */
